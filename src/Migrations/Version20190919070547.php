...
final class Version20190919070547 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedigree_kinship RENAME INDEX IDX_52F7EC39D1F91D63 TO IDX_2058874D1F91D63');
        $this->addSql('ALTER TABLE pedigree_kinship RENAME INDEX IDX_52F7EC39D3BFA33A TO IDX_2058874D3BFA33A');
    }
}
